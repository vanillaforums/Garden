...
class Pocket {
    ...
    public function canRender($data) {
        ...
        $eventManager->fire('settingsController_AdditionalPocketFilters', ["testMode" => $testMode, "pocketAdmin" => $pocketAdmin, "SubcommunityIDs" => $this->SubcommunityIDs]);
...
//        return !empty($this->SubcommunityIDs);
//    }
